...
9. 系统会在报告旁以表格展示每种材料的价格/用量/价格效应/用量效应分解明细，
   因此涉及材料分解的正文不必逐材料罗列全部数字，点出影响最大的 1~2 种材料、
   讲清结论与原因即可——明细交给表格，正文讲逻辑
10. summary 与 suggestions 同样受数字白名单校验：其中出现的每个数字都必须
    原样取自指标包/知识包；全文 citations 至少引用 1 条知识证据，causes 至少 1 条"""
